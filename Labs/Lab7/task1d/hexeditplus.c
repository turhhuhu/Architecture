...
int main(int argc, char **argv)
{
    ...
    char inputAsString[MAX_INPUT_SIZE];
    struct fun_desc menu[] = {{"Toggle Debug Mode", toggleDebug}, {"Set File Name", setFileName}, {"Set Unit Size", setUnitSize}, {"Load Into Memory", loadIntoMem}, {"Toggle Display Mode", toggleDisplay}, {"Memory Display", memoryDisplay}, {"Save Into File", saveIntoFile}, {"Quit", quit}, {NULL, NULL}};
