...
convertor:
	...
	for_loop_hexa: ;converting the decimal number to hex number
		...
		cmp eax, 0 ; making sure if we finished running through the whole number (if eax is 0 we finished)
		jz end_loop_hexa ; jumping to the end if the above is true
